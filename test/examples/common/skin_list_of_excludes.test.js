[false, true].forEach(function(responsive) {
	...
	describe('skin/body: list of excludes ' + (responsive ? '(responsive)' : '(async)'), function() {

		var contexts = {loaded : []};
		before(function(done) {
			loadPage('/examples/common/skin_list_of_excludes.html?responsive=' + responsive, sizes.LARGE, function(win, doc) {
