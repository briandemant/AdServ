[false, true].forEach(function(responsive) {
	...
	describe('skin/body: without background ' + (responsive ? '(responsive)' : '(async)'), function() {
		
		var contexts = {loaded : []};
		before(function(done) {
			loadPage('/examples/common/skin_without_background.html?responsive=' + responsive, sizes.LARGE, function(win, doc) {
