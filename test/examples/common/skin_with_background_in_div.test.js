[false, true].forEach(function(responsive) {
	...
	describe('skin/div: with background ' + (responsive ? '(responsive)' : '(async)'), function() {
		
		var contexts = {loaded : []};
		before(function(done) {
			loadPage('/examples/common/skin_with_background_in_div.html?responsive=' + responsive, sizes.LARGE, function(win, doc) {
