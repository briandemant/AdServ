describe('skin/div: unchanged without background', function() {
	var contexts = {loaded : []};
	before(function(done) {
		loadPage('/examples/adserv/skin_unchanged_without_background_in_div.html', 800, 800, function(win, doc) {
